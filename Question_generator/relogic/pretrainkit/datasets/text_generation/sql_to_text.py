...
class SQL2QueryDataset(Dataset):
    ...
    def __init__(self, tokenizer: PreTrainedTokenizer, file_path, block_size=-1, local_rank=-1):
        ...
        with open(file_path, encoding="utf-8") as f:
            for line in tqdm(f):
                ...
                sql_tokens = [tokenizer.cls_token] + tokenizer.tokenize(sql) + [tokenizer.sep_token]
