...
function(output_from, data_path='data/spider-20190205/') {
    ...
    data: {
        train: {
            name: 'spider',
            paths: [PREFIX + 'train_pattern.json'],
            tables_paths: [
             PREFIX + 'tables.json',
            ],
        ...
        val: {
            name: 'spider',
            paths: [PREFIX + 'valv2_pattern.json'],
            tables_paths: [PREFIX + 'tables.json'],
            db_path: PREFIX + 'database',
        },
#        gen:{
#            name:'synthesis',
#           paths: [PREFIX + 'gen_input.json'],
#            tables_paths: [PREFIX + 'tables.json'],
#            db_path: PREFIX + 'database',
#        },
#        train: {
#            name: 'DuSQL',
#            paths: [PREFIX + 'train_DuSQL_pattern.json'],
#            tables_paths: [
#             PREFIX + 'DuSQL_schema.json',
#            ],
#            db_path: PREFIX + 'database',
#        },
#        val: {
#            name: 'DuSQL',
#            paths: [PREFIX + 'dev_DuSQL_pattern.json'],
#            tables_paths: [PREFIX + 'DuSQL_schema.json'],
#            db_path: PREFIX + 'database',
#        },
#        gen:{
#            name:'synthesis',
#            paths: [PREFIX + 'rematched_TEST.json'],
#            tables_paths: [PREFIX + 'DuSQL_schema.json'],
#            db_path: PREFIX + 'database',
#        },
    },
