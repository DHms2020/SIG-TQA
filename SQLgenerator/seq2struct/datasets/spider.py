...
@registry.register('dataset','synthesis')
class SpiderDataset(torch.utils.data.Dataset):
    def __init__(self, paths, tables_paths, db_path):
        self.paths = paths
        self.db_path = db_path
        self.examples = []
        ...
        for path in paths:
            ...
            for entry in raw_data:
                item = SynthesisItem(
                    text=entry['pattern_toks'],
                    cvalues=entry['cvalues'],
...
@registry.register('dataset', 'DuSQL')
class SpiderDataset(torch.utils.data.Dataset):
    # def __init__(self, paths, tables_paths, db_path, limit=None):
    def __init__(self, paths, tables_paths, db_path):
        self.paths = paths
