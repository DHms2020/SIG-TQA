...
def multiword_tokenize(text, mwe):
    ...
    tokenizer = nltk.tokenize.MWETokenizer(protected_tuples)
    # Tokenize the text.
...
def tokenize(string):
    ...
    # toks = [word.lower() for word in tokenizer.tokenize(string,add_prefix_space=False)]
    # print(toks)
    # toks = [word.lower() for word in word_tokenize(string)]
    mwe=['people.Home Town','performance.Official_ratings_(millions)']
    toks=[word.lower() for word in multiword_tokenize(string,mwe)]
